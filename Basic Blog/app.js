...
app.get('/posts/:postName', (req, res)=>{
  ...
  //iterating through posts array, if the title matches requested title
  //render specific post page
  posts.forEach(function(post){
    if(lodash.lowerCase(searchPost) === lodash.lowerCase(post.postTitle)){
      res.render('post',{
...
//clear array button, for debuggin purposes
